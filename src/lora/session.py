...
from .io import append_jsonl, read_json, utc_now, validate_path_id, write_json
...
class SessionManager:
    ...
    def create(self, case_id: str, mode: str = "e2e") -> SessionRef:
        ...
        write_json(self._pygent_session_path(session_id), session.to_dict())
    ...
    def _save_session(self, session: AgentSession) -> None:
        ...
        write_json(self._pygent_session_path(session.session_id), session_data)
