...
_TITLE_ELISION_RIGHT_GUTTER = 24
...
class SessionSidebar(QWidget):
    ...
    def set_collapsed(self, collapsed: bool) -> None:
        ...
        self.new_button.setVisible(not collapsed)
        ...
        self.tools_card.setVisible(not collapsed)
        self.project_button.setVisible(not collapsed)
        self.day_button.setVisible(not collapsed)
        self.night_button.setVisible(not collapsed)
        self.settings_button.setVisible(not collapsed)
        self.brand_title.setText("Lora")
            ...
            if available > 0:
                ...
                self._title_label.setText(
                    metrics.elidedText(
                        self._full_title,
                        Qt.ElideRight,
                        max(1, available - _TITLE_ELISION_RIGHT_GUTTER),
                    )
                )
